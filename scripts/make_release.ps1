...
"@
    ...
    $formatted_log = $git_log | ForEach-Object {
        # Convert hash to markdown link
        $_ -replace '([a-z0-9]{7})', '[$1](https://github.com/pkoretic/LetiHome/commit/$1)' |
        # Remove # comments
    ...
    $formatted_log | Add-Content $tempfile
